...
- **El repartidor entra con nombre y PIN**: toca su nombre (la primera vez; después el celular lo recuerda) y escribe seis números. El PIN se lo pone el dueño desde la ficha del repartidor. Cinco errores seguidos bloquean la cuenta quince minutos (`docs/PLAN.md` sección 18).
