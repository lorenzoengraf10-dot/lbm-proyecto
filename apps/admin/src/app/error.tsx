 ...
 * resto del panel. Sin este archivo, Next muestra su pantalla genérica en
 * inglés — "This page couldn't load" — que no dice qué pasó ni qué hacer.
 * `retry` es el nombre del callback en esta versión de Next (antes se
 * llamaba `reset`).
 */
  ...
  return (
    <main className="flex flex-1 items-center justify-center p-6">
      <div className={`${estilos.tarjeta} w-full max-w-xs space-y-4 p-6`}>
        ...
        <Mensaje tipo="error">Algo falló en el panel. Probá de nuevo.</Mensaje>
